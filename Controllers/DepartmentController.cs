...
namespace Bangazon.Controllers
{
	public class DepartmentController: Controller
	{
		...
		public IActionResult Post([FromBody]Department department)
		{
			...
			_context.Customer.Add(department);
			...
			{
				if (DepartmentExists(department.CustomerId))
				{
			...
			return CreatedAtRoute("GetSingleCustomer", new { id = department.DepartmentId }, department);
		}
